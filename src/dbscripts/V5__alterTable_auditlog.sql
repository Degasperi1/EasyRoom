/* 
 Alterações realizadas para aumentar a segurança da trigger de auditoria.
 Criação de chave estrangeira que vincula a tabela de usuários à tabela de auditoria
 */
/**
 * Author:  evand
 * Created: 30/09/2020
